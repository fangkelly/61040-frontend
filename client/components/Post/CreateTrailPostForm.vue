...
const createPost = async (content: string, media: string) => {
  ...
  console.log("body ", { content, media });
  try {
...
<template>
  <form @submit.prevent="createPost(content, media)" class="trail-post-form">
    ...
    <v-textarea v-model="content" class="trailPost-form" variant="outlined" color="#95b08d" required label="Create post for this location!" :rules="rules"></v-textarea>
